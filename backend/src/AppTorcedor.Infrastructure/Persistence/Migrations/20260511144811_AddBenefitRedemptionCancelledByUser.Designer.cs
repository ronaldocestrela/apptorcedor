...
namespace AppTorcedor.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260511144811_AddBenefitRedemptionCancelledByUser")]
    partial class AddBenefitRedemptionCancelledByUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.BenefitRedemptionRecord", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CancelledByUserAtUtc")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.ProcessedStripeWebhookEventRecord", b =>
                {
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.SupportTicketHistoryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.SupportTicketMessageAttachmentRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SupportTicketMessageAttachments", (string)null);
                });

            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.SupportTicketMessageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.SupportTicketRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.SupportTicketHistoryRecord", b =>
                {
                    ...
                    b.HasOne("AppTorcedor.Infrastructure.Entities.SupportTicketRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AppTorcedor.Infrastructure.Entities.SupportTicketMessageAttachmentRecord", b =>
                {
                    b.HasOne("AppTorcedor.Infrastructure.Entities.SupportTicketMessageRecord", null)
                        .WithMany()
