...
/// <summary>
/// Inbox idempotente para webhooks do gateway no contexto SaaS (master).
/// </summary>
public sealed class TenantPaymentWebhookInbox : AggregateRoot
{
    private TenantPaymentWebhookInbox()
    {
    }
    ...
    public static TenantPaymentWebhookInbox Receive(string idempotencyKey, string eventType, string rawPayload)
    {
        if (string.IsNullOrWhiteSpace(idempotencyKey))
            throw new ArgumentException("Idempotency key is required.", nameof(idempotencyKey));

        return new TenantPaymentWebhookInbox
        {
