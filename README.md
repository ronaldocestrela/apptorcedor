...
frontend/         → React + Vite (login, convite staff, **usuários admin**, dashboard admin, **pagamentos admin (B.6)**, **notícias admin (B.9)**, gestão de matriz de permissões, refresh de token)
