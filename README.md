...
frontend/         → React + Vite (login, convite staff, **usuários admin**, dashboard admin, **pagamentos admin (B.6)**, **notícias admin (B.9)**, **fidelidade/benefícios admin (B.10)**, gestão de matriz de permissões, refresh de token)
