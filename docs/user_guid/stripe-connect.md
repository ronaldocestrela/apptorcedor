...
- **SaaS:** `POST /api/webhooks/stripe/saas` — segredos globais em `Payments:*` (ver `docs/Stripe/configuracao-chaves-e-webhooks.md`).
...
Guia passo a passo para o admin do clube: **`docs/user_guid/tenant-stripe-connect.md`** (gateway Stripe direto).
