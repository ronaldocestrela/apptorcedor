...
* **Foto de perfil centralizada (`/account`):** `<p>` que envolve o `<img>` de foto recebeu `style={{ textAlign: 'center' }}` para centralização horizontal.