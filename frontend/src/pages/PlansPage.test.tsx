...
describe('PlansPage', () => {
  ...
  it('renders catalog with header, featured badge and MAIS DETALHES links', async () => {
    ...
    expect(container.querySelector('.plans-page--figma')).toBeInTheDocument()
    expect(container.querySelector('.plans-figma-list')).toBeInTheDocument()
    expect(container.querySelectorAll('.plans-figma-card')).toHaveLength(1)
